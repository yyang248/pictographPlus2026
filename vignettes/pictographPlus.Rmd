...
```{r}
head(read.csv(system.file('extdata/examples/example4_snv_with_purity.csv', package = 'pictographPlus')))
```
...
```{r}
head(read.csv(system.file('extdata/examples/example3_snv_with_purity.csv', package = 'pictographPlus')))
```
...
```{r}
head(read.csv(system.file('extdata/examples/rna_example.csv', package = 'pictographPlus')))
```
